...
namespace FTN.ESI.SIMES.CIM.CIMAdapter.Importer
{
	...
	public class PowerTransformerImporter
	{
        ...
        private void ImportRecloseSequences()
        {
        ...
        private ResourceDescription CreateRecloseSequenceResourceDescription(FTN.RecloseSequence cimRecloseSequence)
        {
            ...
            if (cimRecloseSequence != null)
            {
                ...
                ////populate ResourceDescription
                PowerTransformerConverter.PopulateRecloseSequenceProperties(cimRecloseSequence, rd, importHelper, report);
            }
            return rd;
        }
